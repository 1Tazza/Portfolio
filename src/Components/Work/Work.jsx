    ...
    <div className={`${c.font} ${c.center} `}>
     ...
     <div className={c.workContainer}>
      ...
      <div className={c.row} style={{justifyContent: "space-evenly"}}>
       ...
       <a href={cartImage} data-lightbox="image-1" data-title="HenryGameStore"><img id={checked === false ? c.imgNight : null} src={cartImage} className={c.cartImg} alt="" /></a>
        <p style={{fontFamily: 'Raleway', fontSize: "20px"}} id={checked === true ? c.beige : c.white}>Link: <a id={checked === true ? c.beige : c.white} style={{fontSize: "23px"}} className={checked === true ? c.dayGlow : c.nightGlow}  href="https://pf-front-y72g-git-develop-pfgrupo3henry.vercel.app/" target="_blank">HenryGameStore</a></p> 
      </span>
      </div>
     </div>
     ...
     <div className={`${c.workContainer} ${c.frontContainer}`}>
      ...
      <div className={c.row} style={{justifyContent: "space-evenly"}}>
       ...
       <p style={{fontFamily: 'Raleway', fontSize: "20px"}} id={checked === true ? c.beige : c.white}>Link: <a id={checked === true ? c.beige : c.white} style={{fontSize: "23px"}} className={checked === true ? c.dayGlow : c.nightGlow}  href="https://pidogsfrontend-production.up.railway.app/" target="_blank">Dogs App</a></p> 
      </span>
      </div>
     </div>
